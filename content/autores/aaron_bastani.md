...
tags: [aceleracionismo, post-capitalismo, automatización, izquierda-británica, corbynismo]
---
...
- La automatización como liberación del trabajo necesario
- El lujo universal como horizonte político de la izquierda
- La apropiación democrática de tecnologías emergentes
- El rechazo a la austeridad como programa político de izquierda

### Tensiones y limitaciones

Las reseñas académicas señalan consistentemente la misma debilidad: Bastani no tiene teoría del poder ni de la transición. Su lectura de Marx es selectiva —usa el argumento de las fuerzas productivas pero ignora su reflexión ecológica tardía. Su solución a los límites planetarios (minería de asteroides) reproduce la lógica extractivista del capitalismo.
...
- [Reseña Society & Space](https://www.societyandspace.org/articles/fully-automated-luxury-communism-a-manifesto-by-aaron-bastani) — análisis del marco teórico y sus limitaciones ecológicas
- [Reseña Theory, Culture & Society](https://www.theoryculturesociety.org/blog/review-aaron-bastani-fully-automated-luxury-communism) — crítica del problema del agente político
