...
date: 2026-04-18
updated: 2026-04-18
sources: [raw/no-ficcion/less-is-more-notas_Miguel.md, raw/ficcion/los_desposeidos_notas_Miguel.md]
tags: [decrecimiento, ecosocialismo, limites-planetarios, desacoplamiento, teoria-del-cambio]
---
...
Corriente de pensamiento económico y político que propone una reducción planificada y democrática del uso de energía y materiales en las economías ricas, acompañada de redistribución radical y transformación de los valores. No es sinónimo de recesión: la recesión es lo que ocurre cuando una economía *dependiente* del crecimiento deja de crecer; el decrecimiento propone construir una economía que no *necesite* crecer para funcionar bien. La wiki trabaja el concepto principalmente a través de [[obras/less_is_more|Less Is More]] y de su conexión con [[obras/los_desposeidos|Los Desposeídos]].

## Contenido principal

### Definición y distinción clave

El núcleo del argumento decrecentista: el crecimiento económico continuo choca de forma inevitable con los límites biofísicos del planeta. El "desacoplamiento verde" —crecer reduciendo simultáneamente el uso de recursos— no se ha producido a escala ni velocidad suficientes, y hay razones estructurales para dudar de que pueda producirse.

La distinción entre recesión y decrecimiento es conceptualmente central: una economía calibrada para crecer que deja de hacerlo colapsa (desempleo, deuda, impagos). El decrecimiento propone transformar la arquitectura subyacente para que el bienestar no dependa del crecimiento —lo que requiere un trabajo institucional y cultural muy diferente a simplemente "reducir".

### El argumento de los materiales

Incluso tras una transición energética completa hacia renovables, seguir creciendo al ritmo proyectado implicaría doblar el stock global de paneles solares, turbinas eólicas y baterías cada 30-40 años, indefinidamente. Los límites materiales del crecimiento no desaparecen con la descarbonización. Este es uno de los argumentos más sólidos del decrecimiento y el más subestimado en el debate público.

### Decrecimiento y ecosocialismo: una tensión no resuelta

¿El problema ecológico radica en el crecimiento como imperativo macroeconómico (tesis decrecentista) o en el capitalismo como relación social de producción (tesis ecosocialista clásica)? La distinción tiene consecuencias para el programa político:
...
Kohei Saito (véase [[obras/less_is_more|Less Is More]]) intenta resolver esta tensión desde dentro del marxismo, con más éxito filosófico que Hickel. La wiki rastrea esta tensión sin resolverla.
...
[[conceptos/acid_communism|Comunismo Ácido]] proporciona el vocabulario para nombrar este problema: la izquierda abandonó el terreno del deseo al capitalismo. El decrecimiento dominante reproduce ese error. Véase [[conexiones/revolucion_hedonismo_decrecimiento|Revolución, Hedonismo y Decrecimiento]].
...
[[obras/los_desposeidos|Los Desposeídos]] puede leerse como un intento de imaginar cómo funciona una sociedad de suficiencia durante generaciones. Anarres demuestra que el decrecimiento puede funcionar como hecho social. Lo que no muestra es cómo hacer que la gente lo *desee* ni cómo se construye la transición desde una economía de crecimiento. Le Guin es más honesta sobre las contradicciones internas de la suficiencia que Hickel, que toma el modelo sin los conflictos.
...
- [[obras/less_is_more|Less Is More]] — la obra principal que trabaja el concepto en la wiki
...
- `raw/no-ficcion/less-is-more-notas_Miguel.md` — análisis central; preguntas abiertas; conexiones teóricas
- `raw/ficcion/los_desposeidos_notas_Miguel.md` — sección "La implicación para el decrecimiento"
